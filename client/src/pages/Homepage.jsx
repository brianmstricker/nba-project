...
const Homepage = () => {
  ...
  const [fantasyTeam, setFantasyTeam] = useContext(FantasyTeamContext);
  const addPlayerToFantasyTeam = (player) => {
    setFantasyTeam([...fantasyTeam, player]);
  };
  useEffect(() => {
        ...
        {players.map((player) => (
          ...
          >
            ...
            <Card.Body className="d-flex flex-column align-items-center">
              ...
              <Button
                variant="primary"
                onClick={() => addPlayerToFantasyTeam(player)}
              >
                Add to Team
              </Button>
            </Card.Body>
